  ...
  template: `
    ...
    <section id="hero" class="hero">
      ...
      <div class="cmyk-deco">
        ...
        <div class="c2"></div>
        <div class="c3"></div>
        <div class="c4">CMYK</div>
      </div>
      <div class="hero-content">
        <span class="hero-label">Imprimerie professionnelle — Conakry</span>
        <h1>
        ...
        <p class="hero-sub">
          Des impressions haute définition qui donnent vie à vos idées.
          Bâches, banderoles, affiches, roll-up — nous imprimons tout ce qui fait votre image.
        </p>
    ...
    <div class="stats-bar">
      ...
      <div class="stat"><span class="stat-num">8<em>ans</em></span><span class="stat-lbl">D'expérience</span></div>
    ...
    <section id="services" class="section section--dark">
      <div class="section-header">
        ...
        <h2>NOS <em>SERVICES</em><br>D'IMPRESSION</h2>
    ...
    <section id="about" class="section about-section">
      <div class="about-visual">
        <div class="about-main"><div class="about-main-text">VDP</div></div>
        <div class="about-accent"><p>QUALITÉ<br>PROFESSIONNELLE</p></div>
        <div class="about-badge"><span>N°1</span><small>Conakry</small></div>
      </div>
    ...
    <section id="actualites" class="section">
      <div class="section-header">
        <span class="section-label">Ce qui se passe</span>
        <h2>ACTUALITÉS &<br><em>RÉALISATIONS</em></h2>
      </div>
    ...
    <section id="contact" class="section section--dark">
      <div class="contact-inner">
        <div class="contact-info">
          ...
          <h3>DEMANDEZ<br>VOTRE DEVIS<br><em>GRATUIT</em></h3>
...
export class HomeComponent implements OnInit {
  ...
  serviceOptions = [
    ...
    'Panneaux & Enseignes','Packaging & Flyers','Autre'
  ];
  ...
  services = [
    ...
    { num:'05', icon:'🪧', title:'Panneaux & Enseignes', desc:'Panneaux rigides, enseignes lumineuses et signalétique directionnelle pour votre commerce ou entreprise.' },
  ...
  contactItems = [
    ...
    { icon:'📞', label:'Téléphone', value:'+224 XXX XXX XXX' },
    { icon:'✉️', label:'Email',    value:'contact@vdesignprint.com' },
  ...
  sendContact(): void {
    ...
    // TODO : connecter à votre endpoint de contact
    alert('✅ Votre demande a été envoyée ! Nous vous recontacterons très bientôt.');
